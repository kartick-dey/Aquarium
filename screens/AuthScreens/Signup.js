...
const SignupScreen = ({ navigation }) => {
    ...
    return (
        ...
        <View style={styles.container}>
                <LinarGradient colors={['#f2f2f2', '#f2f2f2']} style={{ flex: 1, paddingTop: 80 }}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.textHeader}>Upload a Photo</Text>
                </View>
                <Animatable.View
                    ...
                    <View style={styles.action}>
                        <FontAwesome name="envelope-o" color="#05375a" size={18}></FontAwesome>
                        <TextInput
                    ...
                    <View style={styles.action}>
                            <Feather name="phone" color="#05375a" size={20}></Feather>
                        <TextInput
                    ...
                    <View style={styles.action}>
                        ...
                        <TouchableOpacity onPress={() => updatePasswordSecureTextEntry()}>
                            {data.secureTextEntry ?
                                <Feather name="eye-off" color='black' size={20}></Feather>
                                :
                                <Feather name="eye" color='black' size={20}></Feather>
                            }
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.button}>
                        ...
                        <TouchableOpacity
                            ...
                            <Text>Have an account?</Text>
                                <Text style={[styles.textSign, { color: '#05375a', fontSize: 22 }]}>Login</Text>
                        </TouchableOpacity>
                    </View>
                </Animatable.View>
            </LinarGradient>
